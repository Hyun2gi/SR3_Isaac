...
void CMomParts::Motion_Change()
{
	if (m_ePreState != m_eCurState)
	{
		...
		case CMomParts::MOM_DOOR:
			m_iPicNum = 1;
			m_fFrameSpeed = 1.f;
			m_pTextureCom = dynamic_cast<CTexture*>(Engine::Get_Component(ID_STATIC, L"GameLogic", L"MomParts", L"Proto_MomDoorTexture"));
			break;

		case CMomParts::MOM_EYE:
			m_iPicNum = 1;
			m_fFrameSpeed = 1.f;
			m_pTextureCom = dynamic_cast<CTexture*>(Engine::Get_Component(ID_STATIC, L"GameLogic", L"MomParts", L"Proto_MomEyeTexture"));
			break;

		case CMomParts::MOM_SKIN:
			m_iPicNum = 2;
			m_fFrameSpeed = 1.f;
			m_pTextureCom = dynamic_cast<CTexture*>(Engine::Get_Component(ID_STATIC, L"GameLogic", L"MomParts", L"Proto_MomSkinTexture"));
			break;

		case CMomParts::MOM_HAND:
			m_iPicNum = 3;
			m_fFrameSpeed = 1.f;
			m_pTextureCom = dynamic_cast<CTexture*>(Engine::Get_Component(ID_STATIC, L"GameLogic", L"MomParts", L"Proto_MomHandTexture"));
			break;
		}
