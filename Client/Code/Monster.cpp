...
CMonster::CMonster(LPDIRECT3DDEVICE9 pGraphicDev)
	...
	m_fCallLimit(0.f), m_fAccTimeDelta(0.f), m_fSpeed(0.f), m_fSecAccTimeDelta(0.f), m_fSlowDelta(0.f), m_fColorTimeDelta(0.f), m_bIsLoadCreatEnd(false),
	m_bDead(false), m_bHit(false), m_bBoss(false), m_eMstType(MONSTER_TYPE_END), m_bHitColor(false), m_eBossType(NONE_BOSS), m_bTimeScale(false), m_bCreate(false)
{
}
...
CMonster::CMonster(const CMonster& rhs)
	...
	m_fCallLimit(rhs.m_fCallLimit), m_fAccTimeDelta(rhs.m_fAccTimeDelta), m_fSpeed(rhs.m_fSpeed), m_fSecAccTimeDelta(rhs.m_fSecAccTimeDelta), m_fSlowDelta(rhs.m_fSlowDelta), m_bCreate(rhs.m_bCreate), m_bIsLoadCreatEnd(rhs.m_bIsLoadCreatEnd),
	m_bDead(rhs.m_bDead), m_bHit(rhs.m_bHit), m_bBoss(rhs.m_bBoss), m_eMstType(rhs.m_eMstType), m_bHitColor(rhs.m_bHitColor), m_eBossType(rhs.m_eBossType), m_bTimeScale(rhs.m_bTimeScale)
{
}
