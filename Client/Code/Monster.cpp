...
CMonster::CMonster(LPDIRECT3DDEVICE9 pGraphicDev)
	...
	m_bDead(false), m_bHit(false), m_bBoss(false), m_eMstType(MONSTER_TYPE_END)
{
...
CMonster::CMonster(const CMonster& rhs)
	...
	m_bDead(rhs.m_bDead), m_bHit(rhs.m_bHit), m_bBoss(rhs.m_bBoss), m_eMstType(rhs.m_eMstType)
{
}
