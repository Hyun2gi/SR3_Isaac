...
CMapObj::CMapObj(LPDIRECT3DDEVICE9 pGraphicDev)
	...
	m_pBufferCom(nullptr), m_pTransformCom(nullptr), m_pTargetTransCom(nullptr), m_pTextureCom(nullptr),
	m_iHitCount(0), m_iLimitHit(0)
{
}

CMapObj::CMapObj(const CMapObj& rhs)
	: Engine::CGameObject(rhs),
	m_pBufferCom(rhs.m_pBufferCom), m_pTransformCom(rhs.m_pTransformCom), m_pTargetTransCom(rhs.m_pTargetTransCom), m_pTextureCom(rhs.m_pTextureCom),
	m_iHitCount(rhs.m_iHitCount), m_iLimitHit(rhs.m_iLimitHit)
{
}
