...
#pragma region MonsterTexture
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_DopleDeadTexture", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/Resource/Texture/Monster/Dople/DopleDead.png")), E_FAIL);
...
#pragma endregion MapObject
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_PlayerTexture_Get_GOOD_ITEM", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/Resource/Texture/Isaac/isaac_get_good_item.png", 1)), E_FAIL);
