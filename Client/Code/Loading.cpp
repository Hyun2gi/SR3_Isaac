...
#pragma endregion MapObject
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_StageWallCubeTexture", CTexture::Create(m_pGraphicDev, TEX_CUBE, L"../Bin/Resource/Texture/Wall/StageWallCube2.dds")), E_FAIL);
