...
#pragma endregion MapObject
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_ObstacleTexture", CTexture::Create(m_pGraphicDev, TEX_CUBE, L"../Bin/Resource/Texture/Obstacle/Rock.dds")), E_FAIL);
...
#pragma region UI Texture
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_PlayerCoinFontTexture", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/Resource/Texture/Ui/Item/Font_%d.png", 10)), E_FAIL);
