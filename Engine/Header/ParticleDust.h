...
class ENGINE_DLL CParticleDust : public CParticleSystem
{
public:
	explicit CParticleDust(int numParticles, _float fSize);
	virtual ~CParticleDust();
...
public:
	static CParticleDust* Create(IDirect3DDevice9* pDevice, _matrix matWorld, _float fSize = 0.25f, _int iCount = 10);
