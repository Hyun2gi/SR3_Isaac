...
CParticleDust::CParticleDust(int numParticles, _float fSize)
{
	m_fSize = fSize;
	m_VbSize = 2048;
	m_VbOffset = 0;
...
CParticleDust::~CParticleDust()
{
	Free();
}

void CParticleDust::Free()
{
	Engine::Safe_Release(m_pVb);
	Engine::Safe_Release(m_pTex);
}

bool CParticleDust::Ready_Particle(IDirect3DDevice9* pDevice)
{
	...
	wstring wstr = L"../Bin/Resource/Texture/Particle/dustCloud.png";
...
void CParticleDust::Reset_Partice(Attribute* attribute)
{
...
CParticleDust* CParticleDust::Create(IDirect3DDevice9* pDevice, _matrix matWorld, _float fSize, _int iCount)
{
	CParticleDust* pInstance = new CParticleDust(iCount, fSize);
