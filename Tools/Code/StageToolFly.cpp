...
#include "..\Header\StageToolFly.h"

#include "Export_Utility.h"

CStageToolFly::CStageToolFly(LPDIRECT3DDEVICE9 pGraphicDev)
	: Engine::CUI(pGraphicDev)
{

}

CStageToolFly::CStageToolFly(const CStageToolFly& rhs)
	: Engine::CUI(rhs)
{
}

CStageToolFly::~CStageToolFly()
{
}

HRESULT CStageToolFly::Ready_GameObject()
{
...
Engine::_int CStageToolFly::Update_GameObject(const _float& fTimeDelta)
{
...
void CStageToolFly::LateUpdate_GameObject()
{
	__super::LateUpdate_GameObject();
}

void CStageToolFly::Render_GameObject()
{	
...
HRESULT CStageToolFly::Add_Component()
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Engine::Clone_Proto(L"Proto_StageToolFly"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
	m_mapComponent[ID_STATIC].insert({ L"Proto_StageToolFly", pComponent });
	...
	_float fWinCX, _float fWinCY)
{
	...
	if (FAILED(pInstance->Ready_GameObject()))
	{
		...
		MSG_BOX("StageToolFly Create Failed");
		return nullptr;
	}
