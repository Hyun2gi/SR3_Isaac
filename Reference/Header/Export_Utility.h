...
inline void	Create_Explosion(LPDIRECT3DDEVICE9 pGraphicDev, _matrix matWorld, _float fSize = 1.f, _int iCount = 10, const _tchar* pTexturePath = L"../Bin/Resource/Texture/Particle/explosion.png");
