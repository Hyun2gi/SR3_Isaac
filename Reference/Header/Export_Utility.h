...
//ParticleMgr
inline void	Create_Scatter(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vMin = _vec3(-10.0f, -5.0f, -10.0f), _vec3 vMax = _vec3(10.0f, 5.0f, 10.0f), _float fSize = 0.25f, _int iCount = 30);
