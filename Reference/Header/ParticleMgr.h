...
public:
	...
	void	Kill_Scatter();
	void	Create_Explosion(LPDIRECT3DDEVICE9 pGraphicDev, _matrix matWorld, _float fSize = 0.7f, _int iCount = 10, _float fSpeed = 2.f, const _tchar* pTexturePath = L"../Bin/Resource/Texture/Particle/explosion.png");
